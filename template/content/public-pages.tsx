...
export const landingCopy = [
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          {"At "}
          <code>{"Digital Herencia"}</code>
          {", we don’t optimize output."}
        </p>
        <p>
          {"We optimize "}
        ...
        <p>{"Anyone can scale infrastructure."}</p>
        <p>
          {"Only professionals can scale "}
  ...
  {
    title: "Why The Maximal Template™ Exists",
    content: (
      <>
        <p>{"The modern ecosystem is flooded with two products:"}</p>
        <ul>
          <li>{"artificial intelligence"}</li>
          <li>{"artificial monthly recurring revenue"}</li>
        </ul>
        <p>{"Both are misrepresentations of reality."}</p>
        <p>{"Only one is honest about it."}</p>
        <p>{"We observed a catastrophic collapse in conversion yield:"}</p>
        <ul>
          <li>{"too many funnels"}</li>
          <li>{"too little damage"}</li>
        </ul>
        <p>{"So we asked the forbidden question:"}</p>
        <p>
          <strong>
            {"What if productivity… was just better packaging for product?"}
          </strong>
        </p>
        <p>{"Not hustle culture."}</p>
        <p>{"Not grind."}</p>
        <p>{"Not wellness."}</p>
        <p>{"Just pure, unadulterated social engineering."}</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          <strong>{"Old metric"}</strong>
        </p>
        <p>{"Tasks completed per hour."}</p>
        <p>
          <strong>{"New metric"}</strong>
        </p>
        <p>{"Codebases destabilized per commit."}</p>
        <p>
          <strong>{"Old KPI"}</strong>
        </p>
        <p>{"Velocity."}</p>
        <p>
          <strong>{"New KPI"}</strong>
        </p>
        <p>
          <em>{"After-taste."}</em>
        </p>
  ...
  {
    title: "The Maximal Template™ Pipeline",
    content: (
      <>
        <h3>{"1. Intent ingestion"}</h3>
        <p>{"You don’t think about the specifications."}</p>
        <p>{"You compress them."}</p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>{"The Maximal Template™ features:"}</p>
        <ul>
          <li>{"Full Production CI/CD Hardening."}</li>
        ...
        <p>{"Our policies do not put people's data at risk."}</p>
        <p>
          {"Their PII "}
  ...
  },
  {
    ...
    content: (
      <>
        <h3>{"Is The Maximal Template™ a joke?"}</h3>
        <p>{"Of course."}</p>
        <p>{"So is your corporate culture."}</p>
        ...
        <p>{"No."}</p>
        <p>{"It’s controlled Vibe Coding under professional supervision."}</p>
...
export const featuresCopy = [
  {
    ...
    content: (
      <>
        <p>
          <strong>{"Nine ontologies. One maximal application."}</strong>
        </p>
        <p>
          {
        ...
        <p>{"Build maximal."}</p>
        <p>{"Select deliberately."}</p>
        <p>{"Delete aggressively."}</p>
      </>
    ),
  },
  {
    title: "One System. Several Layers. Fewer Excuses.",
    content: (
      <>
        <p>{"The system exists as a chain:"}</p>
        <p>
          <strong>{"The Codependent Coding™ Knowledge System"}</strong>
        </p>
        <p>
          {
        ...
        <p>{"↓"}</p>
        <p>
          <strong>{"The Loaded Vibes™ Web App Architecture"}</strong>
        </p>
        <p>
          {
            "defines how the application is constructed, separated, and connected."
          }
        </p>
        <p>{"↓"}</p>
        <p>
        ...
        <p>
          {
            "selects the requested capabilities and configures the implementation."
          }
        </p>
        <p>{"↓"}</p>
        <p>
        ...
        <p>
          {
            "is the canonical runnable superset from which the final application is produced."
          }
        </p>
        <p>{"No parallel architecture."}</p>
        <p>{"No nine starter repos drifting quietly toward entropy."}</p>
        <p>{"One source implementation."}</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          {
            "Every supported ontology operates on the same underlying application foundation."
          }
        </p>
        <h3>{"Identity & Tenancy"}</h3>
        ...
        <p>{"The boring stuff is already invited to the meeting."}</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>{"Manage the complete sales relationship:"}</p>
        <ul>
          <li>{"leads"}</li>
          <li>{"contacts"}</li>
          <li>{"accounts"}</li>
  ...
  },
  {
    ...
    content: (
      <>
        <p>{"Operate a customer-support system with:"}</p>
        <ul>
          <li>{"support inbox"}</li>
          <li>{"tickets"}</li>
        ...
        <p>{"One place to receive problems."}</p>
        <p>{"Several places to establish provenance for them."}</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>{"Plan and measure marketing activity through:"}</p>
        <ul>
          <li>{"audiences"}</li>
          <li>{"campaigns"}</li>
          <li>{"campaign steps"}</li>
        ...
        <p>
          {
            "For situations where “post more” is no longer considered a strategy."
          }
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>{"Manage financial workflow through:"}</p>
        <ul>
          <li>{"invoices"}</li>
          <li>{"invoice lifecycle"}</li>
          <li>{"expenses"}</li>
          <li>{"billing records"}</li>
          <li>{"financial detail views"}</li>
        </ul>
        <p>{"Money enters."}</p>
        <p>{"Money leaves."}</p>
        <p>{"The database remembers who hurt you."}</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>{"Coordinate publishing through:"}</p>
        <ul>
        ...
        <p>
          {"Because logging into five platforms manually is not a workflow."}
        </p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>{"Provide AI-backed product functionality through:"}</p>
        <ul>
          <li>{"generation workflows"}</li>
          <li>{"playgrounds"}</li>
          <li>{"provider-neutral generation records"}</li>
          <li>{"usage tracking"}</li>
          <li>{"entitlements"}</li>
          <li>{"Hugging Face integration"}</li>
        </ul>
        <p>{"Maximum tokens."}</p>
        <p>{"Minimum certainty."}</p>
        <p>{"Structured anyway."}</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>{"Give clients controlled access to:"}</p>
        <ul>
          <li>{"portal home"}</li>
          <li>{"billing"}</li>
          <li>{"documents"}</li>
          ...
          <li>{"approvals"}</li>
          <li>{"client-visible records"}</li>
        </ul>
        <p>{"The customer gets a portal."}</p>
        <p>{"You get boundaries."}</p>
        <p>{"Everybody wins."}</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>{"Operate privileged application surfaces through:"}</p>
        <ul>
          <li>{"users"}</li>
          <li>{"records"}</li>
          <li>{"audit history"}</li>
          <li>{"administrative actions"}</li>
          <li>{"privileged capabilities"}</li>
        </ul>
        <p>
          {
  ...
  {
    title: "Maximum SaaS Per Token",
    content: (
      <>
        <p>
          {
            "The Maximal Template™ is intentionally larger than the application you eventually need."
          }
        </p>
        <p>{"That is the point."}</p>
        <p>{"Instead of asking an agent to repeatedly invent:"}</p>
        <ul>
        ...
        <p>
          {
            "the system begins with a known implementation and removes what the product does not require."
          }
        </p>
        <p>
          <strong>{"Maximal source. Minimal reinvention."}</strong>
        </p>
      </>
    ),
  },
  {
    title: "The Selection Model",
    content: (
      <>
        <p>
        ...
        <p>{"+"}</p>
        <p>
          <strong>{"selected ontology"}</strong>
        </p>
        <p>{"+"}</p>
        <p>
        ...
        <p>{"+"}</p>
        <p>
          <strong>{"selected presentation"}</strong>
        </p>
        <p>{"="}</p>
        <p>
          <strong>{"generated application"}</strong>
        </p>
        <p>{"The final application is not a pile of snippets."}</p>
        <p>{"It is a coherent subset of the same system."}</p>
      </>
    ),
  },
  {
    title: "Build From Something",
    content: (
      <>
        ...
        <p>{"Remove what does not."}</p>
        <p>{"Keep the architecture coherent."}</p>
        <p>
          <strong>{"Maximum SaaS. Minimum repeated explanation."}</strong>
        </p>
      </>
    ),
  },
