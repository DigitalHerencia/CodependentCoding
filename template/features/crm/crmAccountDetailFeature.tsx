...
import { CrmAccountDetailFeatureClient } from "@/features/crm/crmAccountDetailFeature.client";
import { getCrmRecordWorkflow } from "@/lib/workflows/crmWorkflows";
...
export async function CrmAccountDetailFeature({
  ...
  const record = await getCrmRecordWorkflow("account", accountId);
  ...
  return (
    <CrmAccountDetailTemplate
      ...
      toolbar={<CrmAccountDetailFeatureClient />}
    />
  );
}
