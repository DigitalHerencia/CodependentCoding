...
import { CrmContactDetailFeatureClient } from "@/features/crm/crmContactDetailFeature.client";
...
export async function CrmContactDetailFeature({
  ...
  const record = await getCrmRecordWorkflow("contact", contactId);
  ...
  return (
    <CrmContactDetailTemplate
      ...
      toolbar={<CrmContactDetailFeatureClient />}
    />
  );
}
