...
import { CrmAccountsFeatureClient } from "@/features/crm/crmAccountsFeature.client";
...
export async function CrmAccountsFeature() {
  ...
  const records = workspace.contacts.flatMap((contact) =>
  ...
  return (
    <CrmAccountsTemplate
      ...
      toolbar={<CrmAccountsFeatureClient />}
    />
  );
}
