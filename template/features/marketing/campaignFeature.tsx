...
import { CampaignFeatureClient } from "@/features/marketing/campaignFeature.client";
...
export async function CampaignFeature({ campaignId }: { campaignId: string }) {
  const record = await getMarketingRecordWorkflow("campaign", campaignId);
