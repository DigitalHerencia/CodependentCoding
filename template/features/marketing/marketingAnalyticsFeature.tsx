...
import { MarketingAnalyticsFeatureClient } from "@/features/marketing/marketingAnalyticsFeature.client";
...
export async function MarketingAnalyticsFeature() {
  ...
  return (
    <MarketingAnalyticsTemplate
      ...
      toolbar={<MarketingAnalyticsFeatureClient />}
    />
  );
}
