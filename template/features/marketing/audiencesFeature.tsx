...
import { AudiencesFeatureClient } from "@/features/marketing/audiencesFeature.client";
...
export async function AudiencesFeature() {
  ...
  const records = workspace.audiences;
  ...
  return (
    <MarketingAudiencesTemplate
      ...
      toolbar={<AudiencesFeatureClient />}
    />
  );
}
