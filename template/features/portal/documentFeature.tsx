...
import { DocumentFeatureClient } from "@/features/portal/documentFeature.client";
...
export async function DocumentFeature({ documentId }: { documentId: string }) {
  const record = await getPortalDocumentWorkflow(documentId);
