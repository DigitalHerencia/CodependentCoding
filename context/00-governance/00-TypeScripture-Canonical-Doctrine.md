# TypeScripture™ Canonical Doctrine — Handoff Identity Map

**Status:** controlling handoff authority  
**Date:** 2026-08-28  
**Purpose:** establish the current names, responsibilities, and boundaries Codex must implement without reopening naming-only decisions.
...
## Product and architecture entities
...
The public product/system identity is **The Codependent Coding™ Web App Architecture**. It is governed by TypeScripture, implemented through the Hipster Stack and Maximal Template, configured through Ontology defaults + Anthimeria + Virgule, exposes Simples as its normalized building-block library, materializes Arrangements, and provides Loaded Vibes as post-generation Codex operations support.

The phrase **Codependent Coding™ Knowledge System** is no longer the name of the canonical documentation authority. Where older material uses that phrase to mean the reusable knowledge/doctrine corpus, the current name is **TypeScripture™ Canonical Doctrine**.
